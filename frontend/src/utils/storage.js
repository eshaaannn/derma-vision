...
function compactScan(scan, aggressive = false) {
  ...
  const compacted = {
    ...
    possibleConditions: Array.isArray(scan.possibleConditions) ? scan.possibleConditions.slice(0, 3) : [],
    recommendedSteps: Array.isArray(scan.recommendedSteps) ? scan.recommendedSteps.slice(0, 4) : [],

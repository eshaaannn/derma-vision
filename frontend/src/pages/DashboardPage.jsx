  ...
  return (
    ...
    >
      <div className="grid gap-4 md:grid-cols-3">
        ...
        <Card>
          <h3 className="text-sm font-bold text-slate-800 dark:text-slate-200">Health Awareness</h3>
          <p className="mt-2 text-sm text-slate-600 dark:text-slate-300">
            The ABCDE rule helps identify suspicious moles: Asymmetry, Border, Color,
            Diameter, and Evolution.
          </p>
          <p className="mt-3 rounded-lg bg-blue-50 px-3 py-2 text-xs font-medium text-medicalBlue dark:bg-blue-900/30 dark:text-blue-200">
            Reminder: AI screening supports, but does not replace, dermatologist diagnosis.
          </p>
        </Card>
      </div>

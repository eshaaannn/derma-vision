...
const questionLabels = {
  ...
  severe_sunburn_history: "Bad sunburn history",
  immunosuppression: "Low immunity",
  non_healing: "Not healing",
  new_vs_old_lesion: "New or different spot",
  contact_history: "Close contact history",
  pet_exposure: "Pet or animal exposure",
  sweating_occlusion: "Worse with sweat or tight clothing",
  steroid_cream_use: "Worse after steroid cream",
  immune_risk: "Diabetes or low immunity",
  fever: "Fever/chills",
  pus: "Pus or yellow head",
  trigger_products: "Started after new product",
  allergy_history: "Allergy or eczema history",
  photosensitivity: "Worse in sunlight",
  night_itch: "Worse at night",
};
